...
if (isset($_POST['search'])) {
    ...
    $sql = "Select * from student where sId='$id_no'";
            ...
            $html .= "
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  <div class='box-1'>
                                                  <img src='../userimages/Amal1991.jpg'>
                                                  </div>
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
...
<div class="col">
    <div class="col-md-12">
        <h1 class="text-primary"><i class="fas fa-id-card"></i> Generate ID Card!<small class="text-warning"> Generate Student ID Card!</small></h1>
            ...
            <div class="card jumbotron">
                <div class="card-body">
                    <form class="form" method="POST" action="id-card.php">
                        ...
                        <input class="form-control mr-sm-2" type="search" placeholder="Enter Id No." name="id_no">
